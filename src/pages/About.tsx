            ...
            <div className="relative border-l-4 border-blue-600 ml-6 md:ml-0 md:pl-0">
              ...
              <div className="mb-12 relative flex items-center md:justify-center group">
                ...
                <div className="pl-8 md:pl-0 md:w-1/2 md:pr-12 md:text-right">
                  ...
                  <p className="text-lg font-bold text-slate-900 leading-snug break-keep">한국진로커리어센터 설립</p>
              ...
              <div className="mb-12 relative flex items-center md:justify-center group">
                ...
                <div className="pl-8 md:pl-0 md:w-1/2 md:pl-12 text-left">
                  ...
                  <p className="text-lg font-bold text-slate-900 leading-snug break-keep">한국폴리텍대학 로봇캠퍼스 산학협력 MOU 체결</p>
                </div>
              </div>
              ...
              <div className="mb-12 relative flex items-center md:justify-center group">
                ...
                <div className="pl-8 md:pl-0 md:w-1/2 md:pr-12 md:text-right">
                  ...
                  <p className="text-lg font-bold text-slate-900 leading-snug break-keep">성남시일자리센터 업무협약 체결</p>
                  <p className="text-slate-600 mt-2 text-[15px]">협약 기간: 3년</p>
                </div>
                <div className="hidden md:block md:w-1/2 md:pl-12"></div>
              </div>
              ...
              <div className="mb-12 relative flex items-center md:justify-center group">
                ...
                <div className="pl-8 md:pl-0 md:w-1/2 md:pl-12 text-left">
                  ...
                  <p className="text-lg font-bold text-slate-900 leading-snug break-keep">중랑여성인력개발센터 'AI·디지털 일자리위원회' 발족</p>
                </div>
              </div>
              ...
              <div className="mb-12 relative flex items-center md:justify-center group">
                ...
                <div className="pl-8 md:pl-0 md:w-1/2 md:pr-12 md:text-right">
                  <h3 className="text-2xl font-black text-[#1e3a8a] mb-2 flex items-center md:justify-end gap-2">
                    2026. 08. 18
                    <span className="px-2 py-0.5 bg-blue-600 text-white text-xs rounded-full ml-2">NEW</span>
                  </h3>
                  <p className="text-lg font-bold text-slate-900 leading-snug break-keep">대표이사, 한국폴리텍 로봇캠퍼스 로봇IT과 시간강사 위촉</p>
                  <p className="text-slate-600 mt-2 text-[15px]">교과목: '생성형AI기반 업무자동화 직업진로' (~2026.12.31)</p>
                </div>
                <div className="hidden md:block md:w-1/2 md:pl-12"></div>
              </div>
