    ...
    <div className="w-full bg-slate-50 font-sans min-h-screen pb-32">
      ...
      <div className="hidden">
        <div className="max-w-[1240px] mx-auto px-6 text-center">
          <span className="text-[#1e3a8a] font-bold tracking-widest text-sm mb-4 block uppercase">Corporate Recruitment Consulting</span>
          <h1 className="text-4xl md:text-[42px] font-black text-slate-900 mb-6 tracking-tight">기업 채용 컨설팅</h1>
        </div>
      </div>

      <div className="max-w-[1240px] mx-auto px-6 mt-8 relative">
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 md:p-12">
          <h2 className="text-3xl font-bold text-slate-900 mb-6">기업 채용 컨설팅</h2>
