import { Target, ArrowRight, Rocket, Infinity as InfinityIcon } from "lucide-react";
...
export default function About() {
  return (
    <div className="w-full bg-slate-50 font-sans text-slate-800">
      ...
      <section className="relative pt-10 pb-16 lg:pt-14 lg:pb-20 overflow-hidden bg-white border-b border-slate-200">
        <div
        ...
        <div className="max-w-[1240px] mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-slate-600 leading-[1.8] mb-10 break-keep">
              한국진로커리어센터는 급변하는 4차 산업 기술 트렌드와 고용 시장에 발맞추어, <br></br>실무 역량 중심의
              진로·취업 솔루션을 제공하는 전문 교육 기관입니다. <br></br>한국폴리텍대학 로봇캠퍼스 산학협력 및 지자체
              일자리 거버넌스를 바탕으로, <br></br>공공기관과 기업이 신뢰하는 검증된 교육 인프라를 구축하고 있습니다.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-50 border-t border-slate-200">
        <div className="max-w-[1240px] mx-auto px-6">
          <div className="mb-16 text-center max-w-2xl mx-auto">
            ...
            <h2 className="text-3xl md:text-[40px] font-black text-slate-900 break-keep">
              미래를 준비하는 3가지 핵심 솔루션
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-10 rounded-xl shadow-sm border border-slate-200 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2">
              <div className="w-16 h-16 bg-blue-50 rounded-2xl flex items-center justify-center mb-8">
                <InfinityIcon className="w-8 h-8 text-[#1e3a8a]" strokeWidth={1.5} />
              </div>
        ...
        <div className="max-w-[1240px] mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative border-l-4 border-blue-600 ml-6 md:ml-0 md:pl-0">
              ...
              <div className="mb-12 relative flex items-center md:justify-center group">
                ...
                <div className="pl-8 md:pl-0 md:w-1/2 md:pr-8 md:text-right">
                  <h3 className="text-2xl font-black text-[#1e3a8a] mb-2 flex items-center md:justify-end gap-2">
                    2026. 01. 23
                  </h3>
                  <p className="text-base sm:text-lg font-bold text-slate-900 leading-snug md:whitespace-nowrap">한국진로커리어센터 설립</p>
                  <p className="text-slate-600 mt-2 text-[15px]">대표이사 겸 센터장 체제 출범</p>
                </div>
              ...
              <div className="mb-12 relative flex items-center md:justify-center group">
                ...
                <div className="pl-8 md:pl-0 md:w-1/2 md:pl-8 text-left">
                  <h3 className="text-2xl font-black text-[#1e3a8a] mb-2 flex items-center gap-2">
                    2026. 05. 28
                  </h3>
                  <p className="text-base sm:text-lg font-bold text-slate-900 leading-snug md:whitespace-nowrap">한국폴리텍대학 로봇캠퍼스 산학협력 MOU 체결</p>
                </div>
              </div>
              ...
              <div className="mb-12 relative flex items-center md:justify-center group">
                ...
                <div className="pl-8 md:pl-0 md:w-1/2 md:pr-8 md:text-right">
                  ...
                  <p className="text-base sm:text-lg font-bold text-slate-900 leading-snug md:whitespace-nowrap">성남시일자리센터 업무협약 체결</p>
                </div>
                <div className="hidden md:block md:w-1/2 md:pl-8"></div>
              </div>
              ...
              <div className="mb-12 relative flex items-center md:justify-center group">
                ...
                <div className="pl-8 md:pl-0 md:w-1/2 md:pl-8 text-left">
                  ...
                  <p className="text-base sm:text-lg font-bold text-slate-900 leading-snug md:whitespace-nowrap">중랑여성인력개발센터 'AI·디지털 일자리위원회' 발족</p>
                </div>
              </div>
        ...
        <div className="max-w-[1240px] mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <p className="text-xl md:text-2xl text-slate-300 font-medium leading-relaxed break-keep">
              ...
              기관 및 기업에는 최적의 고용 성과를 창출하는<br className="block md:hidden" /> 신뢰의 파트너로 함께 하겠습니다.
            </p>
            <div className="pt-8">
              <Link
                to="/contact"
                className="inline-flex items-center justify-center px-10 py-4 bg-white text-[#050B14] rounded-full font-bold text-lg hover:bg-cyan-400 transition-colors duration-300 gap-2 group"
              >
