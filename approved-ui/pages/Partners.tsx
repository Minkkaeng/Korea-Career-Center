import { ArrowUpRight, CheckCircle, Handshake } from 'lucide-react';
...
export default function Partners() {
  const partners = [
    ...
    },
    {
      name: '성남인사이트',
      type: '민간기관',
      desc: '지역 혁신 인재 육성 및 정보 공유 플랫폼을 제공하는 전문 기관입니다.',
  ...
  return (
    <div className="w-full bg-slate-50 font-sans min-h-screen pb-32">
      {/* Hero Section */}
      <section className="bg-white pt-8 md:pt-12 pb-12 border-b border-slate-200">
