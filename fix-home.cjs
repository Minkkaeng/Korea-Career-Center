...
const oldHero = `<section className="sticky top-0 w-full h-screen bg-[#050B14] flex items-center justify-center overflow-hidden z-0">
        ...
        >
            ...
            <motion.p 
              ...
              className="text-lg md:text-xl text-slate-300 max-w-2xl font-medium break-keep mb-12 drop-shadow-lg"
            >
