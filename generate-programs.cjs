...
const dir = 'src/pages/programs';
if (!fs.existsSync(dir)){
    fs.mkdirSync(dir, { recursive: true });
}

const templates = {
  'Youth.tsx': { title: '청년 취업역량강화', id: 'Youth Capacity Building' },
  'AiConsulting.tsx': { title: 'AI 활용 진로상담', id: 'AI Career Counseling' },
  'Corporate.tsx': { title: '기업 채용 컨설팅', id: 'Corporate Recruitment Consulting' },
  'Special.tsx': { title: '특강·위탁교육', id: 'Special Lectures & Consignment Education' }
};
    ...
    <div className="w-full bg-slate-50 font-sans min-h-screen pb-32">
      ...
      <div className="hidden">
        <div className="max-w-[1240px] mx-auto px-6 text-center">
          <span className="text-[#1e3a8a] font-bold tracking-widest text-sm mb-4 block uppercase">${data.id}</span>
          <h1 className="text-4xl md:text-[42px] font-black text-slate-900 mb-6 tracking-tight">${data.title}</h1>
        </div>
      </div>
...
console.log('4 program pages generated');
